...
pub enum ResponsePayload {
    ...
    NumberOfStates(u64),
    StatesValuesWithProof(StateValueChunkWithProof),
...
impl ResponsePayload {
    pub fn get_label(&self) -> &'static str {
        match self {
            ...
            Self::StatesValuesWithProof(_) => "state_values_with_proof",
...
impl From<StateValueChunkWithProof> for ResponsePayload {
    fn from(inner: StateValueChunkWithProof) -> Self {
        Self::StatesValuesWithProof(inner)
    }
}
...
impl AdvertisedData {
    ...
    pub fn lowest_states_version(&self) -> Option<Version> {
